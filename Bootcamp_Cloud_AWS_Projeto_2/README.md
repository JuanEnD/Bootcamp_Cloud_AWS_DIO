## Neste projeto foi criado uma API REST, Tabela de Banco de Dados com DynamoDB, Back-end com AWS Lambda. Em seguida foi feita uma integração da API com o Back-end do Lambda para escrever dados no DynamoDB.
